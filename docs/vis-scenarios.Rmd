...
map_fun = function(df, ratio_diff_value, scenario_value){
  #Feb 13 2023
  ...
  qtm_obj = zcta_ca_geo_simplified %>% 
    left_join(df_measures, by = "zcta") %>% 
    qtm(
      fill.title = ratio_diff_value,
      fill = "value_cat",
      fill.palette = "plasma"
    )
...
hosp_ratio_long %>% #note the aspatial data
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[1])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[1])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[2])
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[2])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[3])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[3])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[4])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[4])
```
s
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[5])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[5])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[6])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[6])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[7])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[7])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[8])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[8])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[9])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[9])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[10])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[10])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[11])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[11])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[12])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% 
  map_fun(ratio_diff_value="diff", scenario_value=scenario_list[12])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[13])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% map_fun(ratio_diff_value="diff", scenario_value=scenario_list[13])
```
...
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_ratio_long %>% 
  map_fun(ratio_diff_value="ratio", scenario_value=scenario_list[14])
```

Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long %>% map_fun(ratio_diff_value="diff", scenario_value=scenario_list[14])
```
