...
source(here("scripts","link-zcta-hosp-data.R"))#load measures
...
Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long_geo %>% mv_fun(ratio_diff_value="diff", scenario_value=scenario_list[13])
```
...
Difference
```{r, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE}
hosp_diff_long_geo %>% mv_fun(ratio_diff_value="diff", scenario_value=scenario_list[14])
```
